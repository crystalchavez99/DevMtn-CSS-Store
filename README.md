...
For example, if you have a square (25 by 25 pixels) on your dom, you can apply a `margin-right` of 20px. What this essentially does is takes your element and makes it 45px by 25px, however you do not see the additional 20px added on to the element. Margin helps, in this case, to make sure that no element can get within 20px to the right of the element. 
